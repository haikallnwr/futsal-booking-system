        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('dev.gors.update', $gor->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('user_id') is-invalid @enderror" id="user_id" name="user_id" required>
                                        ...
                                        @foreach($admins as $admin)
                                            <option value="{{ $admin->id }}" {{ old('user_id', $gor->user_id) == $admin->id ? 'selected' : '' }}>
                        ...
                        <div class="row mb-3">
                            @forelse($gor->images as $image)
                                <div class="col-md-3 mb-3 text-center">
                                    <img src="{{ asset('storage/' . $gor->images->first()->image_path) }}" alt="GOR Image" class="img-thumbnail mb-2" style="max-height: 150px;">
                        ...
                        <div class="mb-3">
                            <label for="images" class="form-label">Add More GOR Images (Can select multiple)</label>
                        ...
                        <button type="submit" class="btn btn-primary">Update GOR</button>
